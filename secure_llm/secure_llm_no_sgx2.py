...
class NonSgxSecureLLM:
    ...
    def Get_Encrypted_Tensor_PV_Int32(cls, src_id1, src_id2):
        ...
        cls.lib.Ex_Get_Encrypted_Tensor_PV_Int32(src_id1, src_id2, cast(enc_x.data_ptr(), POINTER(c_uint32)), cast(enc_y.data_ptr(), POINTER(c_uint32)))
        return enc_x, enc_y

    @classmethod    
    def Generate_Decryption_Key_PV_Int32(cls, src_id1, src_id2):
        cls.lib.Ex_Generate_Decryption_Key_PV_Int32(src_id1, src_id2)
    ...
    def Get_Encrypted_Tensor_QK_Int32_KV_Cache_Opt(cls, src_id1, src_id2, layer_id):
        ...
        cls.lib.Ex_Get_Encrypted_Tensor_QK_Int32_KV_Cache_Opt(src_id1, src_id2, cast(enc_x.data_ptr(), POINTER(c_uint32)), cast(enc_y.data_ptr(), POINTER(c_uint32)), layer_id)
        return enc_x, enc_y
    
    @classmethod
    def Generate_Decryption_Key_QK_Int32_KV_Cache_Opt(cls, src_id1, src_id2, layer_id):
        cls.lib.Ex_Generate_Decryption_Key_QK_Int32_KV_Cache_Opt(src_id1, src_id2, layer_id)

    @classmethod
    def Set_Decrypted_Tensor_QK_Int32_KV_Cache_Opt(cls, src, layer_id):
        return cls.lib.Ex_Set_Decrypted_Tensor_QK_Int32_KV_Cache_Opt(cast(src.data_ptr(), POINTER(c_uint32)),
                                                          src.size(0), src.size(
    ...
    def Get_Encrypted_Tensor_PV_Int32_KV_Cache_Opt(cls, src_id1, src_id2, layer_id):
        ...
        cls.lib.Ex_Get_Encrypted_Tensor_PV_Int32_KV_Cache_Opt(src_id1, src_id2, cast(enc_x.data_ptr(), POINTER(c_uint32)), cast(enc_y.data_ptr(), POINTER(c_uint32)), layer_id)
        return enc_x, enc_y
    
    @classmethod
    def Generate_Decryption_Key_PV_Int32_KV_Cache_Opt(cls, src_id1, src_id2, layer_id):
        cls.lib.Ex_Generate_Decryption_Key_PV_Int32_KV_Cache_Opt(src_id1, src_id2, layer_id)
    
    @classmethod
    def Set_Decrypted_Tensor_PV_Int32_KV_Cache_Opt(cls, src, layer_id):
        return cls.lib.Ex_Set_Decrypted_Tensor_PV_Int32_KV_Cache_Opt(cast(src.data_ptr(), POINTER(c_uint32)),
                                                          src.size(0), src.size(
                                                              1), src.size(2), layer_id)

    @classmethod
    def Pre_Init(cls):
        return cls.lib.Ex_Pre_Init()
    
    @classmethod
    def Reset(cls):
        return cls.lib.Ex_Reset()
