...
class SgxLayerStructC:
  ...
  def Get_Encrypted_Tensor_QK_Int32_KV_Cache_Opt(cls, src_id1, src_id2, layer_id):
      ...
      cls.lib.Sgx_Get_Encrypted_Tensor_QK_Int32_KV_Cache_Opt(cls.eid[0], src_id1, src_id2, cast(enc_x.data_ptr(), POINTER(c_uint32)), cast(enc_y.data_ptr(), POINTER(c_uint32)), layer_id)
      return enc_x, enc_y
  
  @classmethod
  def Generate_Decryption_Key_QK_Int32_KV_Cache_Opt(cls, src_id1, src_id2, layer_id):
      cls.lib.Sgx_Generate_Decryption_Key_QK_Int32_KV_Cache_Opt(cls.eid[0], src_id1, src_id2, layer_id)

  @classmethod
  def Set_Decrypted_Tensor_QK_Int32_KV_Cache_Opt(cls, src, layer_id):
      return cls.lib.Sgx_Set_Decrypted_Tensor_QK_Int32_KV_Cache_Opt(cls.eid[0], cast(src.data_ptr(), POINTER(c_uint32)),
                                                        src.size(0), src.size(
                                                            1), src.size(2), layer_id)
  ...
  def Get_Encrypted_Tensor_PV_Int32_KV_Cache_Opt(cls, src_id1, src_id2, layer_id):
      ...
      cls.lib.Sgx_Get_Encrypted_Tensor_PV_Int32_KV_Cache_Opt(cls.eid[0], src_id1, src_id2, cast(enc_x.data_ptr(), POINTER(c_uint32)), cast(enc_y.data_ptr(), POINTER(c_uint32)), layer_id)
      return enc_x, enc_y
  
  @classmethod
  def Generate_Decryption_Key_PV_Int32_KV_Cache_Opt(cls, src_id1, src_id2, layer_id):
      cls.lib.Sgx_Generate_Decryption_Key_PV_Int32_KV_Cache_Opt(cls.eid[0], src_id1, src_id2, layer_id)
  
  @classmethod
  def Set_Decrypted_Tensor_PV_Int32_KV_Cache_Opt(cls, src, layer_id):
      return cls.lib.Sgx_Set_Decrypted_Tensor_PV_Int32_KV_Cache_Opt(cls.eid[0], cast(src.data_ptr(), POINTER(c_uint32)),
                                                        src.size(0), src.size(
                                                            1), src.size(2), layer_id)
  @classmethod
  def Pre_Init(cls):
  ...
  def Get_Encrypted_Tensor_QK_Int32(cls, src_id1, src_id2):
      ...
      cls.lib.Sgx_Get_Encrypted_Tensor_QK_Int32(cls.eid[0], src_id1, src_id2, cast(enc_x.data_ptr(), POINTER(c_uint32)), cast(enc_y.data_ptr(), POINTER(c_uint32)))
      return enc_x, enc_y

  @classmethod
  def Generate_Decryption_Key_QK_Int32(cls, src_id1, src_id2):
      cls.lib.Sgx_Generate_Decryption_Key_QK_Int32(cls.eid[0], src_id1, src_id2)
  
  @classmethod
  def Set_Decrypted_Tensor_QK_Int32(cls, src):
      return cls.lib.Sgx_Set_Decrypted_Tensor_QK_Int32(cls.eid[0], cast(src.data_ptr(), POINTER(c_uint32)),
                                                        src.size(0), src.size(
                                                            1), src.size(2))
  ...
  def Get_Encrypted_Tensor_PV_Int32(cls, src_id1, src_id2):
      ...
      cls.lib.Sgx_Get_Encrypted_Tensor_PV_Int32(cls.eid[0], src_id1, src_id2, cast(enc_x.data_ptr(), POINTER(c_uint32)), cast(enc_y.data_ptr(), POINTER(c_uint32)))
      return enc_x, enc_y

  @classmethod    
  def Generate_Decryption_Key_PV_Int32(cls, src_id1, src_id2):
      cls.lib.Sgx_Generate_Decryption_Key_PV_Int32(cls.eid[0], src_id1, src_id2)
  
  @classmethod
  def Set_Decrypted_Tensor_PV_Int32(cls, src):
      return cls.lib.Sgx_Set_Decrypted_Tensor_PV_Int32(cls.eid[0], cast(src.data_ptr(), POINTER(c_uint32)),
                                                        src.size(0), src.size(
                                                            1), src.size(2))
