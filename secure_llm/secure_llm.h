#ifndef SECURE_LLM_SGX_ENCLAVE_SECURE_LLM_H
#define SECURE_LLM_SGX_ENCLAVE_SECURE_LLM_H

/*
  This is secure_llm ecalls
*/  
...
void Ex_Get_Encrypted_Tensor_QK_Int32(int src_id1, int src_id2, uint32_t* out1,
                                      uint32_t* out2);
void Ex_Generate_Decryption_Key_QK_Int32(int src_id1, int src_id2);
int Ex_Set_Decrypted_Tensor_QK_Int32(uint32_t* data, int B, int M, int N);

void Ex_Get_Encrypted_Tensor_PV_Int32(int src_id1, int src_id2, uint32_t* out1,
                                      uint32_t* out2);
void Ex_Generate_Decryption_Key_PV_Int32(int src_id1, int src_id2);
int Ex_Set_Decrypted_Tensor_PV_Int32(uint32_t* data, int B, int M, int N);
