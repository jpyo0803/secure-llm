...
std::vector<std::vector<int32_t>> x_row_sum_buffer;
std::vector<std::vector<int32_t>> y_col_sum_buffer;
...
std::vector<std::vector<int32_t>> x_row_sum_buffer_opt_list[MAX_NUM_LAYERS];
std::vector<std::vector<int32_t>> y_col_sum_buffer_opt_list[MAX_NUM_LAYERS];

// For PV Cache OPT
std::vector<std::vector<std::pair<uint32_t, int32_t>>> key_a_opt_list2[MAX_NUM_LAYERS]; // key and index
std::vector<std::vector<std::pair<uint32_t, int32_t>>> key_b_opt_list2[MAX_NUM_LAYERS];

std::vector<std::vector<std::pair<uint32_t, int32_t>>> key_c_opt_list2[MAX_NUM_LAYERS]; // key and index
std::vector<std::vector<std::pair<uint32_t, int32_t>>> key_d_opt_list2[MAX_NUM_LAYERS];

std::vector<std::vector<uint32_t>> z_row_factor_opt_list2[MAX_NUM_LAYERS];
std::vector<std::vector<uint32_t>> z_col_factor_opt_list2[MAX_NUM_LAYERS];
std::vector<uint32_t> z_dot_product_factor_opt_list2[MAX_NUM_LAYERS];
bool z_dot_product_factor_opt_list_done2[MAX_NUM_LAYERS];

std::vector<std::vector<int32_t>> x_row_sum_buffer_opt_list2[MAX_NUM_LAYERS];
std::vector<std::vector<int32_t>> y_col_sum_buffer_opt_list2[MAX_NUM_LAYERS];

int share_dim_pv_opt;
