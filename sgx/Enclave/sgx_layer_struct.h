...
void Sgx_Generate_Decryption_Key_QK_Int32_KV_Cache_Opt(int src_id1, int src_id2, int layer_id);
int Sgx_Set_Decrypted_Tensor_QK_Int32_KV_Cache_Opt(uint32_t* data, int B, int M, int N, int layer_id);

void Sgx_Get_Encrypted_Tensor_PV_Int32_KV_Cache_Opt(int src_id1, int src_id2,
                                                     uint32_t* out1, uint32_t* out2, int layer_id);
void Sgx_Generate_Decryption_Key_PV_Int32_KV_Cache_Opt(int src_id1, int src_id2, int layer_id);
int Sgx_Set_Decrypted_Tensor_PV_Int32_KV_Cache_Opt(uint32_t* data, int B, int M, int N, int layer_id);

void Sgx_Get_Encrypted_Tensor_QK_Int32(int src_id1, int src_id2, uint32_t* out1,
                                      uint32_t* out2);
void Sgx_Generate_Decryption_Key_QK_Int32(int src_id1, int src_id2);
int Sgx_Set_Decrypted_Tensor_QK_Int32(uint32_t* data, int B, int M, int N);

void Sgx_Get_Encrypted_Tensor_PV_Int32(int src_id1, int src_id2, uint32_t* out1,
                                      uint32_t* out2);
void Sgx_Generate_Decryption_Key_PV_Int32(int src_id1, int src_id2);
int Sgx_Set_Decrypted_Tensor_PV_Int32(uint32_t* data, int B, int M, int N);
