...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Set_Decrypted_Tensor_Opr1_Int32(void* pms)
{
	...
	ecall_Sgx_Set_Decrypted_Tensor_Opr1_Int32(_tmp_data, __in_ms.ms_B, __in_ms.ms_M, __in_ms.ms_N, __in_ms.ms_blind_factor_id, __in_ms.ms_linear_param_id, _tmp_ret_id);
...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Get_Encrypted_Tensor_Opr2_Int32(void* pms)
{
	...
	ecall_Sgx_Get_Encrypted_Tensor_Opr2_Int32(__in_ms.ms_src_id1, __in_ms.ms_src_id2, _tmp_out1, _tmp_out2, _tmp_ret_id);
...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Set_Decrypted_Tensor_Opr2_Int32(void* pms)
{
	...
	ecall_Sgx_Set_Decrypted_Tensor_Opr2_Int32(_tmp_data, __in_ms.ms_B, __in_ms.ms_M, __in_ms.ms_N, __in_ms.ms_unblind_factor_id, _tmp_ret_id);
...
SGX_EXTERNC const struct {
	size_t nr_ecall;
	struct {void* ecall_addr; uint8_t is_priv; uint8_t is_switchless;} ecall_table[30];
} g_ecall_table = {
	30,
	{
