...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Get_Encrypted_Tensor_QK_Int32(void* pms)
{
	...
	uint32_t* _tmp_out1 = __in_ms.ms_out1;
	uint32_t* _tmp_out2 = __in_ms.ms_out2;


	ecall_Sgx_Get_Encrypted_Tensor_QK_Int32(__in_ms.ms_src_id1, __in_ms.ms_src_id2, _tmp_out1, _tmp_out2);
...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Generate_Decryption_Key_QK_Int32(void* pms)
{
	...
	ecall_Sgx_Generate_Decryption_Key_QK_Int32(__in_ms.ms_src_id1, __in_ms.ms_src_id2);
...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Set_Decrypted_Tensor_QK_Int32(void* pms)
{
	...
	sgx_status_t status = SGX_SUCCESS;
	uint32_t* _tmp_data = __in_ms.ms_data;
	int* _tmp_ret_id = __in_ms.ms_ret_id;


	ecall_Sgx_Set_Decrypted_Tensor_QK_Int32(_tmp_data, __in_ms.ms_B, __in_ms.ms_M, __in_ms.ms_N, _tmp_ret_id);
...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Get_Encrypted_Tensor_PV_Int32(void* pms)
{
	...
	ecall_Sgx_Get_Encrypted_Tensor_PV_Int32(__in_ms.ms_src_id1, __in_ms.ms_src_id2, _tmp_out1, _tmp_out2);
...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Generate_Decryption_Key_PV_Int32(void* pms)
{
	...
	ecall_Sgx_Generate_Decryption_Key_PV_Int32(__in_ms.ms_src_id1, __in_ms.ms_src_id2);
...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Set_Decrypted_Tensor_PV_Int32(void* pms)
{
	...
	ecall_Sgx_Set_Decrypted_Tensor_PV_Int32(_tmp_data, __in_ms.ms_B, __in_ms.ms_M, __in_ms.ms_N, _tmp_ret_id);
...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Generate_Decryption_Key_QK_Int32_KV_Cache_Opt(void* pms)
{
	...
	ecall_Sgx_Generate_Decryption_Key_QK_Int32_KV_Cache_Opt(__in_ms.ms_src_id1, __in_ms.ms_src_id2, __in_ms.ms_layer_id);
...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Set_Decrypted_Tensor_QK_Int32_KV_Cache_Opt(void* pms)
{
	...
	ecall_Sgx_Set_Decrypted_Tensor_QK_Int32_KV_Cache_Opt(_tmp_data, __in_ms.ms_B, __in_ms.ms_M, __in_ms.ms_N, __in_ms.ms_layer_id, _tmp_ret_id);
...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Generate_Decryption_Key_PV_Int32_KV_Cache_Opt(void* pms)
{
	...
	ecall_Sgx_Generate_Decryption_Key_PV_Int32_KV_Cache_Opt(__in_ms.ms_src_id1, __in_ms.ms_src_id2, __in_ms.ms_layer_id);
...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Set_Decrypted_Tensor_PV_Int32_KV_Cache_Opt(void* pms)
{
	...
	ecall_Sgx_Set_Decrypted_Tensor_PV_Int32_KV_Cache_Opt(_tmp_data, __in_ms.ms_B, __in_ms.ms_M, __in_ms.ms_N, __in_ms.ms_layer_id, _tmp_ret_id);
...
static sgx_status_t SGX_CDECL sgx_ecall_Sgx_Reset(void* pms)
{
	sgx_status_t status = SGX_SUCCESS;
	if (pms != NULL) return SGX_ERROR_INVALID_PARAMETER;
	ecall_Sgx_Reset();
...
SGX_EXTERNC const struct {
	size_t nr_ecall;
	struct {void* ecall_addr; uint8_t is_priv; uint8_t is_switchless;} ecall_table[44];
} g_ecall_table = {
	44,
	{
		...
		{(void*)(uintptr_t)sgx_ecall_Sgx_Reset, 0, 0},
